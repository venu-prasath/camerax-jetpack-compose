...
class MainActivity : ComponentActivity() {
    ...
    private fun takeVideo(
        ...
        val outputFile = File(filesDir, "test-recording.mp4")
            ...
            object: OnImageCapturedCallback() {
                override fun onCaptureSuccess(image: ImageProxy) {
                    ...
                    val matrix = Matrix().apply {
                        postRotate(image.imageInfo.rotationDegrees.toFloat()) //rotate to portrait
                        postScale(-1f, 1f) //mirror on x-axis and not on y-axis
                    }
